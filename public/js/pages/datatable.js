...
$(document).ready(function () {
    ...
    $(".dataTables_wrapper .dt-buttons .btn").addClass('btn-light').removeClass('btn-default');
...
var TableAdvanced = function () {
    ...
    var initTable4 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            var sOut = '<table  style="background-color: #f3eab9;">';
            sOut += '<tr><td style="background-color: #f3eab9;">City:</td><td style="text-align: left; background-color: #f3eab9;">' + aData[3] + '</td></tr>';
            sOut += '<tr><td style="background-color: #f3eab9;">Court:</td><td style="text-align: left; background-color: #f3eab9;">' + aData[4] + '</td></tr>';
            sOut += '</table>';
            return sOut;
        }
        /*
